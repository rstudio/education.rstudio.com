...
Posit offers several resources to make it easier for you to teach R, ranging from semester-long courses to more intense (but much shorter) workshops.
...
- **Teach R Markdown.** If you want to teach R Markdown, we have designed several workshops for teaching the basics to the more advanced topics. You can find the materials for a full two-day workshop on [*Advanced R Markdown*](https://arm.rbind.io/) ([source](https://github.com/rstudio-education/arm-workshop-rsc2019)), a four-hour introductory workshop on [*R Markdown for Medicine*](https://rmd4medicine.netlify.app/) ([source](https://github.com/rstudio-education/rmd4medicine)) aimed at clinical researchers, and a full-day workshop on [*Communicating with R Markdown*](https://ysc-rmarkdown.netlify.app/) ([source](https://github.com/rstudio-education/communicate-rmd-workshop)).

- **Teach Quarto.** [Quarto](https://quarto.org/) is the next generation of R Markdown, bringing reproducible publishing to Python, R, Julia, and Observable. The [Get Started with Quarto](https://quarto.org/docs/get-started/) tutorials provide step-by-step guides for multiple development environments including RStudio, VS Code, and Jupyter. Explore the [Quarto gallery](https://quarto.org/docs/gallery/) to see examples of books, websites, presentations, and dashboards you can create with your students.

- [**Teach everything else!**](https://github.com/rstudio-education/) Materials from the most recent Posit (and RStudio) conferences can be found at the following links: [posit::conf(2025) workshops](https://github.com/posit-conf-2025), [posit::conf(2024) workshops](https://github.com/posit-conf-2024), [posit::conf(2023) workshops](https://github.com/posit-conf-2023),
[rstudio::conf(2022) workshops](https://github.com/rstudio-conf-2022). All of these workshop materials are openly licensed and freely available for reuse. Please follow the reuse guidelines in each repository's license, and enjoy using the high-quality teaching materials our team and other workshop instructors have developed.
