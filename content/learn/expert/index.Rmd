...
- __Try your hand at Tensorflow for deep learning.__ Posit hosts a website dedicated to R and TensorFlow at [tensorflow.rstudio.com](https://tensorflow.rstudio.com), where you can learn how to use deep learning in your analyses.
J.J. Allaire and Francois Chollet have published a [*Deep Learning with R* book](https://www.amazon.com/Deep-Learning-R-Francois-Chollet/dp/161729554X) [-@chollet2018deep]. You can hear J.J. describe the philosophy behind the system in his [rstudio::conf 2019 video](https://www.rstudio.com/resources/videos/machine-learning-with-tensorflow-and-r/). For a quick overview of resources for how to get started with deep learning in R, read [Sigrid Keydana's article](https://posit.co/blog/getting-started-with-deep-learning-in-r/) and subscribe to the [Posit AI blog](https://blogs.rstudio.com/ai/).

- __Communicate with Quarto.__ [Quarto](https://quarto.org/) is an open-source scientific and technical publishing system that enables you to create and share beautiful data science products like [books](https://quarto.org/docs/books/), [blogs](https://quarto.org/docs/websites/website-blog.html), [websites](https://quarto.org/docs/websites/), and [presentations](https://quarto.org/docs/presentations/). As the next generation of R Markdown, Quarto unifies and extends the capabilities of bookdown, distill, blogdown, and xaringan in a single multi-language system that works with Python, R, Julia, and Observable. Browse the [Quarto gallery](https://quarto.org/docs/gallery/) to see the range of outputs you can create, from academic articles to interactive dashboards. If you've built an R package, the [pkgdown](https://pkgdown.r-lib.org/) package makes it quick and relatively painless to build a website for your package, using all the work you've already done to write and document your functions.
