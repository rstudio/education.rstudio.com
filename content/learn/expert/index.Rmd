...
- __Dive into the foundations of R.__ Most R users are not programmers, and therefore much of their R code is not as readable, fast, or efficient as it could be. Hadley Wickham's book, *Advanced R* [-@wickham2014advanced] (available for [free online](https://adv-r.hadley.nz/) and as [an O'Reilly paperback from Amazon](http://amzn.com/1466586966?tag=devtools-20)), unlocks many of the secrets behind how R works the way it does, and gives you new strategies for solving diverse problems.
...
- __Communicate with R Markdown.__ The R Markdown family of packages is constantly growing, which means that your options for R Markdown [output formats](https://rmarkdown.rstudio.com/formats.html) is always expanding. Experiment with packages that extend R Markdown and help you publish collections of documents as polished websites like [`bookdown`](https://bookdown.org/yihui/bookdown/), [`distill`](https://rstudio.github.io/distill/), or [`blogdown`](https://bookdown.org/yihui/blogdown/). If you want to present analyses or visualizations made with R code, consider making your [slides](https://bookdown.org/yihui/rmarkdown/xaringan.html) with R Markdown. If you've built an R package, the [`pkgdown`](https://pkgdown.r-lib.org/) package make it quick and relatively painless to build a website for your package.
