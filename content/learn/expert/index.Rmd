...
- __Communicate with R Markdown.__ The R Markdown family of packages is constantly growing, which means that your options for R Markdown [output formats](https://rmarkdown.rstudio.com/formats.html) is always expanding. Experiment with packages like [`bookdown`](https://bookdown.org/yihui/bookdown/), [`distill`](https://rstudio.github.io/distill/), or [`blogdown`](https://bookdown.org/yihui/blogdown/); each  extends R Markdown to help you publish a polished websites for sharing your work. If you want to present analyses or visualizations made with R code, consider making your [slides](https://bookdown.org/yihui/rmarkdown/xaringan.html) with R Markdown. If you've built an R package, the [`pkgdown`](https://pkgdown.r-lib.org/) package makes it quick and relatively painless to build a website for your package.
