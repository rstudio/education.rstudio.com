...
Our education team supports this mission broadly by supporting learners and teachers. This site is designed for both!
...
+ [**Learn**.](/learn) Our advice for how learners can expand their knowledge about R and popular packages from RStudio like tidyverse and Shiny. You'll find three learning pathways to help you become productive in the minimum amount of time, based on your experience level: [beginner](/learn/beginner), [intermediate](/learn/intermediate), and [expert](/learn/expert). The content and links on these pages may change as new resources become available and grab our attention! So rest assured, this page will be kept up-to-date, but that also means that our recommendations might change too.
...
In addition to the beautiful art, this site was built with ✨ CSS magic ✨ contributed by Robby Shaver, Greg Swinehart, and Desirée De Leon. And special thanks to all the members of the [RStudio education team](/author), including our summer interns, who have contributed all the content here so far, and much more to come. 
