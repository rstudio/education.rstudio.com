...
Each section in this course features links to an HTML slide deck, YouTube video, and an RStudio Cloud project. Danielle also has an online resource called ["Learning Statistics with R"](https://learningstatisticswithr.com/), originally designed to teach intro statistics to psychology undergrads.
