...
<img src="palmerpenguins.png" width="30%" style="display:block; margin-left: auto; margin-right: auto;"/>
...
Finally, you can get a pretty clear separation between all three species by looking at bill length versus depth:
